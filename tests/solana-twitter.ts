...
describe("solana-twitter", () => {
  ...
  it("cannot provide a topic with more than 50 characters", async () => {
    try {
      ...
      assert.equal(
        error.msg,
        "Topics can have a maximum length of 50 characters."
      );
      return;
    }

    assert.fail("Topics can have a maximum length of 50 characters.");
  });
  ...
  it("cannot provide a content with more than 280 characters", async () => {
    try {
      ...
      assert.equal(
        error.msg,
        "Content can have a maximum length of 280 characters."
      );
      return;
    }

    assert.fail("Content can have a maximum length of 280 characters.");
  });
